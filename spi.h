...
#define SPI_SPI1_SCK_PORT           GPIOB
#define SPI_SPI1_MISO_PORT          GPIOB
#define SPI_SPI1_MOSI_PORT          GPIOB
#define SPI_SPI1_SCK_PIN            GPIO_Pin_3
//#define SPI_SPI1_MISO_PIN           GPIO_Pin_4
#define SPI_SPI1_MOSI_PIN           GPIO_Pin_5
#define SPI_SPI1_SCK_SOURCE         GPIO_PinSource3
#define SPI_SPI1_MISO_SOURCE        GPIO_PinSource4
#define SPI_SPI1_MOSI_SOURCE        GPIO_PinSource5
...
extern uint16_t spiWriteHalfWord(spiClient_t *spi, uint16_t val);
