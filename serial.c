...
static void serialStartTxDMA(void *param) {
...
serialPort_t *serialUSART1(unsigned int flowControl, unsigned int rxBufSize, unsigned int txBufSize) {
    ...
    s = serialPort1 = (serialPort_t *)calloc(1, sizeof(serialPort_t));
    ...
    s->rxBuf = (volatile unsigned char*)callocDma(1, s->rxBufSize);
    ...
    NVIC_InitStructure.NVIC_IRQChannelPreemptionPriority = SERIAL_ISR_PRIORITY;
    ...
    s->txBuf = (volatile unsigned char*)callocDma(1, s->txBufSize);
    ...
    NVIC_InitStructure.NVIC_IRQChannelCmd = ENABLE;
    NVIC_Init(&NVIC_InitStructure);
//    nvicEnableVector(SERIAL_UART1_TX_IRQn, SERIAL_ISR_PRIORITY);
#else
    // otherwise use interrupts
    NVIC_InitStructure.NVIC_IRQChannel = USART1_IRQn;
    NVIC_InitStructure.NVIC_IRQChannelPreemptionPriority = SERIAL_ISR_PRIORITY;
...
serialPort_t *serialUSART2(unsigned int flowControl, unsigned int rxBufSize, unsigned int txBufSize) {
    ...
    s = serialPort2 = (serialPort_t *)calloc(1, sizeof(serialPort_t));
    ...
    NVIC_InitStructure.NVIC_IRQChannelCmd = ENABLE;
    NVIC_Init(&NVIC_InitStructure);
//    nvicEnableVector(USART2_IRQn, SERIAL_ISR_PRIORITY);
...
serialPort_t *serialUSART3(unsigned int flowControl, unsigned int rxBufSize, unsigned int txBufSize) {
    ...
    s = serialPort3 = (serialPort_t *)calloc(1, sizeof(serialPort_t));
...
serialPort_t *serialUSART4(unsigned int flowControl, unsigned int rxBufSize, unsigned int txBufSize) {
    ...
    s = serialPort4 = (serialPort_t *)calloc(1, sizeof(serialPort_t));
...
serialPort_t *serialUSART5(unsigned int flowControl, unsigned int rxBufSize, unsigned int txBufSize) {
    ...
    s = serialPort5 = (serialPort_t *)calloc(1, sizeof(serialPort_t));
    ...
    GPIO_PinAFConfig(SERIAL_UART5_PORT_RX, SERIAL_UART5_RX_SOURCE, GPIO_AF_UART5);

    GPIO_InitStructure.GPIO_Pin = SERIAL_UART5_RX_PIN;
    GPIO_Init(SERIAL_UART5_PORT_RX, &GPIO_InitStructure);
    ...
    GPIO_PinAFConfig(SERIAL_UART5_PORT_TX, SERIAL_UART5_TX_SOURCE, GPIO_AF_UART5);

    GPIO_InitStructure.GPIO_Pin = SERIAL_UART5_TX_PIN;
    GPIO_Init(SERIAL_UART5_PORT_TX, &GPIO_InitStructure);
...
serialPort_t *serialUSART6(unsigned int flowControl, unsigned int rxBufSize, unsigned int txBufSize) {
    ...
    s = serialPort6 = (serialPort_t *)calloc(1, sizeof(serialPort_t));
